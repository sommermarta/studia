...
<<message=FALSE,warning=FALSE,fig.align='center',fig.height=3.7,fig.width=4.5>>=
# 2.1
...
partimat(as.factor(V1)~V8+V2,data=w)   # albo inaczej
...
m <- read.table("http://www.ipipan.eu/~teisseyrep/TEACHING/DM/DANE/kredit.asc",header=TRUE)
head(m,2)
...
<<message=FALSE,warning=FALSE,fig.align='center',fig.height=5,fig.width=6>>=
# 2.3
