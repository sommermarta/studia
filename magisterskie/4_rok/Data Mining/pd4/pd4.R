...
legend("bottomright",col=c("red","black","green","orange","blue","violet"),
       ...
       lty=c(1,0,1,1,1,1), pch=c(NA,1,NA,NA,NA,NA),cex=0.6,lwd=2)
...
matplot(s,cbind(isef1l,isef1k,isef1s,isef1lo),type="l",
        main="Zaleznosc ISE on n dla f1")
legend("topright",col=1:4,lty=1:4, cex=0.5,
       c("locpoly","ksmooth","smooth.spline","loess"))

matplot(s,cbind(isef2l,isef2k,isef2s,isef2lo),type="l",
        main="Zaleznosc ISE on n dla f2")
legend("topright",col=1:4,lty=1:4, cex=0.5,
       c("locpoly","ksmooth","smooth.spline","loess"))

matplot(s,cbind(isef3l,isef3k,isef3s,isef3lo),type="l",
        main="Zaleznosc ISE on n dla f3")
legend("topright",col=1:4,lty=1:4, cex=0.5,
       c("locpoly","ksmooth","smooth.spline","loess"))
...
legend("bottomright",col=c("red","black","orange","blue"),
       ...
       lty=c(1,0,1,1), pch=c(NA,1,NA,NA),cex=0.6,lwd=2)
